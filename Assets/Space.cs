...
{
    public int total_asteroides = 3;
    public int total_inimigos = 3;
    ...
    void Start()
    {
        ...
        {
            float spawnPointX = Random.Range(-7.0f, 7.0f);
            float spawnPointY = Random.Range(-7.0f, 7.0f);
            float spawnPointZ = Random.Range(-7.0f, 7.0f);
        ...
        for (int i = 0; i < total_inimigos; i++)
        {
            ...
            float spawnPointZ = Random.Range(-7.0f, 7.0f);
            Vector3 spawnPos = new Vector3(spawnPointX, spawnPointY, spawnPointZ);
            GameObject objeto = Instantiate(enemys, spawnPos, Quaternion.identity);
            objeto.transform.parent = gameObject.transform;
